...
use PHPManualFlashCards\FlashCard;
...
class PHPManualDataSource extends AbstractDataSource
{
    ...
    public function getCategories(){
        ...
        $files = scandir($this->phpManualBaseUrl);

        $categories = array();
        foreach($files as $file){
            if(strstr($file,self::MANUAL_URL_PREPEND_BOOK)){
                array_push($categories,str_replace(self::MANUAL_URL_PREPEND_BOOK,'',str_replace('.html','',$file)));
            }
        }
